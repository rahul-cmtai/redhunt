  ...
  return (
    <section className="relative py-20 overflow-hidden group bg-gray-900">
      ...
      >
        ...
        >
          {[
            { icon: ArrowDown, text: '70% Risk Reduction', subtext: 'Lower Hiring Risks' },
            { icon: Clock, text: '40hrs Time Saved', subtext: 'Faster Decisions' },
            { icon: DollarSign, text: '60% Cost Savings', subtext: 'Reduce Expenses' }
          ].map((item, index) => (
            <motion.div 
              key={index}
