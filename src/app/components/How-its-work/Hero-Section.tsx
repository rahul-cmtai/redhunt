  ...
  return (
    <section className="relative py-20 overflow-hidden group bg-gray-900">
      ...
      >
        ...
        >
          Discover how our platform benefits both employers and candidates, creating a transparent hiring ecosystem that builds trust and reduces risks.
        </motion.p>
