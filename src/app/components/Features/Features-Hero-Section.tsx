    ...
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            {[
              { icon: '⚡', label: 'Instant Verification', gradientClass: 'gradient-yellow-orange' },
              { icon: '🔒', label: 'Bank-Level Security', gradientClass: 'gradient-blue-cyan' },
              { icon: '📊', label: 'Advanced Analytics', gradientClass: 'gradient-purple-pink' }
            ].map((item, index) => (
              <motion.div
                key={index}
